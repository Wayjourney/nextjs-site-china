...
export default function InquiryForm() {
  ...
  return (
    <div className='flex items-center justify-center bg-gray-100 py-4 sm:min-h-screen'>
      <div className='w-full max-w-lg bg-white p-8 sm:rounded-lg sm:shadow-md'>
        <h1 className='mb-6 text-center text-2xl font-bold text-slate-800'>联系我们</h1>
